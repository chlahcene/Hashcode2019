...
struct photoB{
    ...
    char type;
    photoB(){};
    photoB (int nIndex,char nType,vector<string> &nTags){
...
struct photoE{
    ...
    char type;
    photoE(){};
    photoE (int nIndex,char nType,vector<string> &nTags){
        // l'ensemble du tags doit etre inithiliser pour hacher
        index = nIndex;
        type = nType;
        for(string s:nTags){
...
struct photoD{
    ...
    char type;
    photoD(){};
    photoD (int nIndex,char nType,vector<string> &nTags){
        // l'ensemble du tags doit etre inithiliser pour hacher
        index = nIndex;
        type = nType;
        for(string s:nTags){
...
struct photoC{
    ...
    char type;
    photoC(){};
    photoC (int nIndex,char nType,vector<string> &nTags){
        // l'ensemble du tags doit etre inithiliser pour hacher
        index = nIndex;
        type = nType;
        for(string s:nTags){
...
vector<photoB> photosB;
vector<photoC> photosC;
vector<photoD> photosD;
vector<photoE> photosE;
...
struct slideshowB{
    ...
    int index2=-1;
    slideshowB(){};
    slideshowB(photoB &ph){
        tags = ph.tags;
        index1 = ph.index;
    };
    slideshowB(photoB &ph1,photoB &ph2){
...
struct slideshowC{
    ...
    int index2=-1;
    slideshowC(){};
    slideshowC(photoC &ph){
        tags = ph.tags;
        index1 = ph.index;
    };
    slideshowC(photoC &ph1,photoC &ph2){
        tags = ph1.tags | ph2.tags;
        index2 = ph2.index;
        index1 = ph1.index;
    };    
    void add(photoC &ph){
...
vector<int> unionVector(vector<int> &V1,vector<int> &V2){
    ...
    vector<int> res(numberV1+numberV2);
